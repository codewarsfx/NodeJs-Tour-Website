...
})({"aXKb2":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ae35fbcf85e124a5";
...
if (domElements.formElement) domElements.formElement.addEventListener('submit', (e)=>{
    ...
    _login.loginUser(emailValue, passwordValue);
});
...
const loginUser = async (email, password)=>{
    try {
        ...
        if (res.data.message) {
            _alert.createAlert("successfully logged in", true);
            window.setTimeout(()=>{
                location.assign('/');
            }, 150);
        }
...
},{"axios":"jo6P5","./alert":"eGrZS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}],"eGrZS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "hideAlert", ()=>hideAlert
);
parcelHelpers.export(exports, "createAlert", ()=>createAlert
);
const hideAlert = ()=>{
